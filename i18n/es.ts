const es = {
  ...
  shop: {
    ...
    wallet_esim_country_one: 'eSIM · {{country}}',
    wallet_esim_country_other: '{{count}} eSIM · {{country}}',
    wallet_esim_generic_one: 'eSIM',
    wallet_esim_generic_other: '{{count}} eSIM',
    my_sims: 'Mis SIMs',
    view_all: 'Ver Todo',
  ...
  marketing: {
    ...
    header_profile_aria: 'Abrir menú de cuenta',
  ...
  topup_page: {
    ...
    esim_guest_title: 'Recarga tu eSIM de viaje',
    esim_guest_body:
      'Inicia sesión para elegir una eSIM ya vinculada a tu cuenta, o explora eSIM por país antes de pagar.',
    esim_open_app: 'Abrir la app Evair',
    esim_browse_travel: 'Nuestro Global eSIM disponible aquí',
    esim_pick_title: 'Elige una línea eSIM',
    esim_pick_hint: 'Selecciona la línea ICCID enlazada a tu cuenta para ver los planes de recarga disponibles.',
    esim_empty_title: '¡No encontramos ningún Global eSIM!',
    esim_empty_body:
      'Compra antes un país o región; cuando tu eSIM figure en la cuenta aparecerá aquí para poder recargar.',
    esim_change_line: 'Elegir otra línea',
    esim_status_active: 'Activa',
    esim_status_inactive: 'Inactiva',
    esim_manual_iccid_toggle: '¿ICCID del correo o soporte?',
    esim_manual_iccid_intro:
      'Solo casos poco frecuentes — abre esta sección y pega tu ICCID completo cuando lo indique soporte.',
    ...
    auth_body_checkout: 'Guardaremos tu historial de recarga y la facturación en un mismo lugar.',
    auth_body_esim:
      'Tras iniciar sesión enumeramos tus eSIM de viaje para normalmente no tener que usar el ICCID.',
    auth_cancel_aria: 'Cerrar',
    auth_cancel: 'Cancelar',
    auth_tab_register: 'Cliente nuevo',
    auth_tab_login: 'Acceder',
    auth_name_label: 'Tu nombre (opcional)',
    ...
    auth_pw_hint: 'Mínimo 8 caracteres.',
    auth_pw_show: 'Mostrar contraseña',
    auth_pw_hide: 'Ocultar contraseña',
    auth_pw_min: 'La contraseña debe tener al menos 8 caracteres.',
    auth_failed: 'No se completó la autenticación.',
    auth_submit_register: 'Crear cuenta y seguir',
    auth_submit_login: 'Iniciar sesión y seguir',
    auth_submitting_register: 'Creando cuenta…',
    auth_submitting_login: 'Accediendo…',
    auth_terms_prefix: 'Al continuar aceptas nuestros',
  ...
  my_sims: {
    ...
    link_esim_pending: 'Esta línea sigue activándose — inténtalo de nuevo más tarde.',
    link_esim_claimed_other:
      'Este eSIM ya está vinculado a otra cuenta. Para ayuda escribe a {{email}}.',
    link_esim_already_linked: 'Este eSIM ya aparece en Mis eSIM.',
    link_esim_missing_sim_id: 'No pudimos relacionar ese ICCID — contacta a soporte.',
    ...
    link_esim_activation_optional: '(opcional)',
    link_esim_activation_placeholder: 'Del inserto o del embalaje',
    link_esim_activation_help:
      'Si falla sin detalles, pega aquí el código de activación impreso en tu embalaje.',
    link_esim_back: 'Volver al ICCID',
    ...
    data_allowance_label: 'Datos incluidos',
    validity_section_label: 'Validez',
    expires_section_label: 'Vence',
    validity_time_left_one: 'Queda {{count}} día',
  ...
  contact: {
    ...
    install_esim: 'Instalar eSIM',
    iccid_help: 'Buscar ICCID',
    device_compatibility: 'Compatibilidad',
    plans_pricing: 'Planes y precios',
    coverage_roaming: 'Cobertura',
    refund_help: 'Reembolsos',
    shipping_sim: 'Envío SIM física',
    ...
    live_staff_cta: 'Enviar mensaje al equipo',
    live_staff_reply_sla: 'Por lo general respondemos en 12 horas',
    live_staff_modal_title: '¿Contactar con personal en vivo?',
    live_staff_modal_body:
      'Un miembro del equipo responderá en el mismo chat. El tiempo típico es de hasta 12 horas. Puede seguir escribiendo mientras espera.',
    ...
    jump_to_recent_pill: 'Últimos mensajes',
    chat_overflow_menu: 'Más opciones',
    menu_live_staff: 'Escribir al equipo',
    menu_jump_to_top: 'Ir al inicio',
    ...
    days_unit: 'días',
    sla_hint: 'Por lo general respondemos en hasta 12 horas.',
