const en = {
  ...
  amazonSim: {
    ...
    sku_section_title: 'Pick a plan · opens Amazon',
  ...
  topup_page: {
    ...
    esim_guest_title: 'Top up your travel eSIM',
    esim_guest_body:
    ...
    esim_manual_iccid_toggle: 'Have an ICCID from email or support?',
    esim_manual_iccid_intro: 'Rare cases only — paste the ICCID after expanding this section.',
    ...
    auth_body_checkout: 'We will save your top-up history and keep billing in one place.',
    auth_body_esim:
      'After signing in we list travel eSIMs on your account so you rarely need an ICCID to top up.',
    auth_cancel_aria: 'Close',
    auth_cancel: 'Cancel',
    auth_tab_register: 'New customer',
    auth_tab_login: 'Sign in',
    auth_name_label: 'Your name (optional)',
    auth_name_placeholder: 'John Smith',
    auth_email_label: 'Email',
    auth_email_placeholder: 'you@example.com',
    auth_password_label: 'Password',
    auth_pw_hint: 'Minimum 8 characters.',
    auth_pw_show: 'Show password',
    auth_pw_hide: 'Hide password',
    auth_pw_min: 'Password must be at least 8 characters.',
    auth_failed: 'Authentication failed.',
    auth_submit_register: 'Create account and continue',
    auth_submit_login: 'Sign in and continue',
    auth_submitting_register: 'Creating account…',
    auth_submitting_login: 'Signing in…',
  ...
  my_sims: {
    ...
    link_esim_success: 'Congratulations — you have linked your eSIM.',
    link_esim_success_continue: 'Continue',
  ...
  contact: {
    ...
    install_esim: 'Install eSIM',
    iccid_help: 'Find ICCID',
    device_compatibility: 'Phone compatibility',
    plans_pricing: 'Plans & pricing',
    coverage_roaming: 'Coverage',
    refund_help: 'Refunds',
    shipping_sim: 'SIM shipping',
    ...
    live_staff_cta: 'Message live staff',
    live_staff_reply_sla: 'We typically reply within 12 hours',
    live_staff_modal_title: 'Connect with live staff?',
    live_staff_modal_body:
      'A team member will respond in the same chat. Typical response time is within 12 hours. You can keep typing while you wait.',
    ...
    jump_to_recent_pill: 'Latest messages',
    chat_overflow_menu: 'More options',
    menu_live_staff: 'Message live staff',
    menu_jump_to_top: 'Jump to beginning',
