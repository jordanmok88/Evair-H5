const zh = {
  ...
  contact: {
    ...
    team_last_active_other: '团队最后一次活动：{{count}} 分钟前',
    leave_message_quick: '留言',
    email_capture_label: '您的电子邮箱',
    email_capture_placeholder: 'name@example.com',
    email_invalid: '请先填写有效的电子邮箱再发送。',
    leave_success_title: '消息已送达',
    leave_success_with_email: '我们已向 {{email}} 发送确认邮件。客服通常在 6–12 小时内回复。',
    leave_success_no_email_delivery: '您的留言已排队，客服通常在 6–12 小时内回复。',
    live_chat_reconnecting_tooltip: '重新连接中…',
    leave_flow_done_cta: '再发一条消息',
  },
  profile: {
    title: '我的',
