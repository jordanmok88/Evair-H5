        ...
        <div style={{ position: 'relative', width: phoneW, height: phoneH, borderRadius: 55, background: '#1a1a1a', padding: '12px 6px', boxShadow: '0 50px 100px -20px rgba(0,0,0,0.25), inset 0 0 0 1px rgba(255,255,255,0.1)' }}>
          ...
          <div style={{ width: '100%', height: '100%', borderRadius: 44, overflow: 'hidden', background: '#F2F4F7', display: 'flex', flexDirection: 'column', position: 'relative' }}>
            ...
            <div style={{ flexShrink: 0, background: '#F2F4F7', borderTop: collapsed ? 'none' : '0.5px solid #C6C6C8', overflow: 'hidden', maxHeight: collapsed ? 0 : 50, opacity: collapsed ? 0 : 1, transition: `max-height ${tr}, opacity ${tr}`, display: 'flex', justifyContent: 'space-around', alignItems: 'center', padding: collapsed ? 0 : '8px 0 0' }}>
              ...
              <svg width="18" height="22" viewBox="0 0 18 22" fill="none"><path d="M9 1v12M5 5l4-4 4 4" stroke="#007AFF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/><path d="M1 11v8a2 2 0 002 2h12a2 2 0 002-2v-8" stroke="#007AFF" strokeWidth="1.8" strokeLinecap="round"/></svg>
