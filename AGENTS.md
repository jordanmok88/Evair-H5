...
2. Human preferences from chats: **`jordan-standing-instructions.mdc`** (agents **extend this file themselves** whenever Jordan expresses a lasting preference — he should not need a special phrase).
