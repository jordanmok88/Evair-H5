...
The PDF is prepared as reader-order pages for saddle stitching. The current layout uses 16 pages so the 12cm booklet stays compact while preserving the full source-manual information. The printing factory should handle booklet imposition.
